...
WebUI.verifyElementVisible(findTestObject('Login/btn_Logout_Menu'))

String actualWelcome = WebUI.getText(
	findTestObject('Login/btn_Welcome_User')
)

WebUI.verifyMatch(actualWelcome, 'Welcome 907802', false)

WebUI.click(findTestObject('Login/btn_Logout_Menu'))
